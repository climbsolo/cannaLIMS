...
<html>
    ...
    <div class="row" style="min-height:10%;">      
        <div class="col-sm-8" style="text-align:left;">
            <div id="main_nav" style="display:none;">               
                <!--<button onclick="setsrc();changeframe($('#frame_managesamples'));$('.p_pagination').fadeIn(250);" class="btn btn-warning">Manage Samples</button>--->
                 <button onclick="changeframe($('#frame_managesamples'));$('.p_pagination').fadeIn(250);" class="btn btn-warning">Manage Samples</button>
                <button onclick="changeframe($('#frame_manageclients'));$('.p_pagination').hide();" class="btn btn-warning">Manage Clients</button>
                <button onclick="changeframe($('#frame_importcsv'));$('.p_pagination').hide();" class="btn btn-warning">Import CSV</button>                
                <button onclick="changeframe($('#frame_workflow'));$('.p_pagination').fadeIn(250);;" class="btn btn-warning">Workflow</button>
                <button onclick="changeframe($('#frame_admin'));$('.p_pagination').hide();" class="btn btn-warning admin_restricted">Admin</button>
            </div>
        </div>
    ...
    var timeoutvalue = <?php echo $session_timeout_check_interval ?>;
    ...
    if (timeoutvalue == null || timeoutvalue.length < 0) { 
       ...
       setInterval(function(){ 
        var luid = '<?php echo $_SESSION["luid"] ?>';
        if (luid == null || luid.length < 0) {
        window.top.location.href = 'logout.php';
        }
        
        jQuery.get("gettimeoutvalue.php", function(data) {
    ...
    <div class="index_frame_div">
        <iframe id="frame_managesamples" class="index_frame" src="managesamples.php" style="width:100%;height:100%;border:none;padding-bottom:0em;"></iframe>
        <iframe id="frame_manageclients" class="index_frame" src="manageclients.php" style="display:none;width:100%;height:100%;border:none;padding-bottom:0em;"></iframe>
        <iframe id="frame_importcsv" class="index_frame" src="importcsv.php" style="display:none;width:100%;height:100%;border:none;padding-bottom:0em;"></iframe>
        <iframe id="frame_workflow" class="index_frame" src="workflow.php" style="display:none;width:100%;height:100%;border:none;padding-bottom:0em;"></iframe>
        <iframe id="frame_admin" class="index_frame" src="admin.php" style="display:none;width:100%;height:100%;border:none;padding-bottom:0em;"></iframe>        
    </div>
...
$(window).load(function() {
    ...
    if (role != "Admin") {
        ...
        $(".indexframe").contents().find(".admin_restricted").addClass("hidden");      
    }
