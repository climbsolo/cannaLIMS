...
class qqFileUploader {
    ...
    function handleUpload($uploadDirectory, $replaceOldFile = TRUE){
        ...
        //$filename = md5($filename.session_id());
...
if (isset( $_GET["license_id"] )) {
    $sample_id = $_GET["license_id"];
}


$uploader = new qqFileUploader($allowedExtensions, $sizeLimit);

if(!is_dir('uploads/' . $sample_id)){
  mkdir ('uploads/' . $sample_id);
}

$result = $uploader->handleUpload('uploads/' . $sample_id . "/");
