...
$homeurl = "http://cannalims.com/phytatech";

$labaddress = "879 Federal Blvd Denver, CO 80204";
$labphone = "(303) 427-2379";

date_default_timezone_set('America/Denver');

// Using PDO for DB Connections
$dbconn = new PDO('mysql:host=localhost;dbname=cannalims_phytatech_v2', 'cl_phytatech', ' kjhKJH8756&^&%47yfuJHg', array(PDO::ATTR_PERSISTENT => true));
